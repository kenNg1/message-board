...
export default Ember.Component.extend({
   ...
   * @public
   */
  validate: function validate(model) {}, // eslint-disable-line no-unused-vars
   ...
   * @public
   */
  onBefore: function onBefore(model) {}, // eslint-disable-line no-unused-vars
   ...
   * @public
   */
  onSubmit: function onSubmit(model, result) {}, // eslint-disable-line no-unused-vars
   ...
   * @public
   */
  onInvalid: function onInvalid(error) {}, // eslint-disable-line no-unused-vars
