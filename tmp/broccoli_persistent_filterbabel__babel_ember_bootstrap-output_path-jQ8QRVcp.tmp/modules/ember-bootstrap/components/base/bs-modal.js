...
export default Ember.Component.extend(TransitionSupport, {
  ...
  hide: function hide() {
    ...
    if (this.get('usesTransition')) {
      this.get('modalElement').one('bsTransitionEnd', Ember.run.bind(this, this.hideModal)).emulateTransitionEnd(this.get('transitionDuration'));
    } else {
      this.hideModal();
    }
  },
    ...
    if (this.get('isOpen') && this.get('backdrop')) {
      ...
      if (doAnimate) {
        Ember.run.schedule('afterRender', this, function () {
          ...
          $backdrop.one('bsTransitionEnd', Ember.run.bind(this, callback)).emulateTransitionEnd(this.get('backdropTransitionDuration'));
        });
      } else {
        callback.call(this);
      }
      ...
      if (doAnimate) {
        $backdrop.one('bsTransitionEnd', Ember.run.bind(this, callbackRemove)).emulateTransitionEnd(this.get('backdropTransitionDuration'));
      } else {
